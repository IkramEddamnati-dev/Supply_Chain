...
var I = r(() => {
  let n = $(), { resource: e, resources: p, id: c, action: y } = Y(), l = se(), d = Ut(), b = he(), { mutate: H } = ho(), { push: K, list: Pt2, create: wt, show: Tt, edit: kt } = Pe(), V = Pt(), $2 = (0, import_react3.useContext)(import_kbar3.KBarContext), { can: a } = aC(), [B, j] = (0, import_react3.useState)([]);
